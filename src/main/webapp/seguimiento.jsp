...
<head>
    ...
    <title>Seguimiento · SumixKids</title>
...
<div class="coming-soon-container">
    <div class="coming-soon-card floating-animation">
        ...
        <p class="coming-soon-description">
            Seguimiento detallado del progreso educativo y desarrollo de competencias de los estudiantes.
            <br><br>
            ¡Monitorea cada avance de forma precisa!
        </p>
