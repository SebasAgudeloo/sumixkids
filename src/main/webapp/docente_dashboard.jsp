...
<head>
    ...
    <title>Panel Docente · SumixKids</title>
    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav me-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link active" href="${pageContext.request.contextPath}/docente_dashboard">
                        📚 Panel Docente
                    </a>
                </li>
                <li class="nav-item">
...
<main class="flex-fill py-5">
    <div class="container">
        <!-- Header personalizado para docente -->
        ...
        <!-- Módulos específicos para docente -->
                ...
                <div class="card stat-card docente h-100 border-0 shadow-lg">
                    <div class="card-body text-center p-4">
                        ...
                        <div class="d-grid gap-2">
                            <a href="${pageContext.request.contextPath}/mis_clases" class="btn btn-primary btn-lg fw-bold">
                                <i class="fas fa-book me-2"></i>Ver Clases
                            </a>
                            <a href="${pageContext.request.contextPath}/crear_clase" class="btn btn-outline-primary">
            ...
            <div class="col-lg-4">
                <div class="card stat-card h-100 border-0 shadow-lg">
                    <div class="card-body text-center p-4">
                        ...
                        <div class="d-grid gap-2">
                            <a href="${pageContext.request.contextPath}/reportes_docente" class="btn btn-info btn-lg fw-bold text-white">
