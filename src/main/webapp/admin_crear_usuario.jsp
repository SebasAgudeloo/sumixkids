                            ...
                            <ul class="navbar-nav me-auto">
                                ...
                                <li class="nav-item dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li><a class="dropdown-item" href="${pageContext.request.contextPath}/grados"><i
                                                    class="fas fa-graduation-cap me-2"></i>Grados Escolares</a></li>
                                        <li><a class="dropdown-item"
                                                href="${pageContext.request.contextPath}/niveles"><i
                                                    class="fas fa-signal me-2"></i>Niveles de Dificultad</a></li>
                                        <li>
                            ...
                            <ul class="navbar-nav">
                                <li class="nav-item dropdown">
                                    <a class="nav-link dropdown-toggle d-flex align-items-center text-white fw-semibold"
                                        ...
                                        <c:choose>
                                            <c:when test="${sessionScope.usuario.rolId == 1}"><i
                                                    class="fas fa-crown me-2"></i></c:when>
                                            <c:when test="${sessionScope.usuario.rolId == 2}"><i
                                                    class="fas fa-chalkboard-teacher me-2"></i></c:when>
                                            <c:when test="${sessionScope.usuario.rolId == 3}"><i
                                                    class="fas fa-graduation-cap me-2"></i></c:when>
                                            <c:when test="${sessionScope.usuario.rolId == 4}"><i
                                                    class="fas fa-users me-2"></i></c:when>
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-end shadow-lg border-0">
                                        <li>
                                            <h6 class="dropdown-item">
                                                <c:choose>
                                                    <c:when test="${sessionScope.usuario.rolId == 1}">👑 Administrador
                                                    </c:when>
                                                    <c:when test="${sessionScope.usuario.rolId == 2}">👨‍🏫 Docente
                                                    </c:when>
                                                    <c:when test="${sessionScope.usuario.rolId == 3}">🎓 Estudiante
                                                    </c:when>
                                                    <c:when test="${sessionScope.usuario.rolId == 4}">👥
                                                        Acompañante/Tutor</c:when>
                                        ...
                                        <li><a class="dropdown-item"
                                                href="${pageContext.request.contextPath}/configuracion"><i
                                        ...
                                        <%-- Botón de eliminar cuenta solo para usuarios no-admin --%>
                                            <c:if
                                                test="${sessionScope.usuario != null && sessionScope.usuario.rolId != 1}">
                                                <li>
                                                    <hr class="dropdown-divider">
                                                </li>
                                                <li>
                                                    <a class="dropdown-item text-danger"
                                                        href="${pageContext.request.contextPath}/eliminar_usuario?tipo=usuario">
                                            ...
                                            <li><a class="dropdown-item"
                                                    href="${pageContext.request.contextPath}/logout"><i
                                                        class="fas fa-sign-out-alt me-2 text-danger"></i>Cerrar
                                                    Sesión</a></li>
                                    </ul>
                                </li>
                            </ul>
                                            ...
                                            <%-- Mensajes de error de validación --%>
                                                ...
                                                <%-- Formulario de registro --%>
                                                    <form id="registroForm" method="post"
                                                        action="${pageContext.request.contextPath}/admin_crear_usuario">
                                                        <div class="form-group">
                                                            <label for="nombres">Nombres:</label>
                                                            <input type="text"
                                                                class="form-control ${errorNombres ? 'is-invalid' : ''}"
                                                                id="nombres" name="nombres" value="${nombres}" required
                                                                maxlength="40"
                                                                placeholder="Ingrese los nombres del usuario a registrar (solo letras, máx. 40 caracteres, máx. 5 espacios)">
                                                            <c:if test="${errorNombres}">
                                                                <div class="invalid-feedback">El nombre solo puede
                                                                    contener letras y espacios (máximo 40 caracteres, máximo 5 espacios)
                                                                </div>
                                                            </c:if>
                                                        </div>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text"
                                                                class="form-control ${errorApellidos ? 'is-invalid' : ''}"
                                                                id="apellidos" name="apellidos" value="${apellidos}"
                                                                required maxlength="40"
                                                                placeholder="Ingrese los apellidos del usuario a registrar (solo letras, máx. 40 caracteres, máx. 5 espacios)">
                                                            <c:if test="${errorApellidos}">
                                                                <div class="invalid-feedback">El apellido solo puede
                                                                    contener letras y espacios (máximo 40 caracteres, máximo 5 espacios)
                                                                </div>
                                                            </c:if>
                                                        </div>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text"
                                                                class="form-control ${errorUsername ? 'is-invalid' : ''}"
                                                                id="username" name="username" value="${username}"
                                                                required maxlength="15" minlength="5"
                                                                placeholder="Entre 5 y 15 caracteres, sin espacios">
                                                            <c:if test="${errorUsername}">
                                                                <div class="invalid-feedback">El usuario debe tener
                                                                    entre 5 y 15 caracteres sin espacios</div>
                                                            </c:if>
                                                        </div>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <c:if test="${errorEmail}">
                                                                <div class="invalid-feedback">El correo electrónico debe
                                                                    tener un formato válido</div>
                                                            </c:if>
                                                        </div>
                                                        ...
                                                        <%-- Selector de rol --%>
                                                            <div class="form-group">
                                                                ...
                                                                <select
                                                                    class="form-select ${errorRolId ? 'is-invalid' : ''}"
                                                                    id="rolId" name="rolId" required>
                                                                    <option value="">Seleccionar rol...</option>
                                                                    <option value="1" ${rolId=='1' ? 'selected' : '' }>
                                                                        👑 Administrador</option>
                                                                    <option value="2" ${rolId=='2' ? 'selected' : '' }>
                                                                        👨‍🏫 Docente</option>
                                                                    <option value="3" ${rolId=='3' ? 'selected' : '' }>
                                                                        🎓 Estudiante</option>
                                                                    <option value="4" ${rolId=='4' ? 'selected' : '' }>
                                                                        👥 Acompañante/Tutor</option>
                                                                </select>
                                                            ...
                                                            <%-- Campo de grado (solo visible cuando el rol es
                                                                Estudiante) --%>
                                                                <div class="form-group" id="gradoContainer"
                                                                    style="display: none;">
                                                                    <label for="grado" class="form-label fw-semibold">
                                                                        <i class="fas fa-graduation-cap me-1"></i>Grado
                                                                        <span class="text-danger"
                                                                            id="gradoRequired">*</span>
                                                                    </label>
                                                                    <select
                                                                        class="form-select ${errorGrado ? 'is-invalid' : ''}"
                                                                        id="grado" name="grado">
                                                                        <option value="">Seleccionar grado...</option>
                                                                        <option value="3" ${grado=='3' || grado=='3°'
                                                                            ? 'selected' : '' }>3°</option>
                                                                        <option value="4" ${grado=='4' || grado=='4°'
                                                                            ? 'selected' : '' }>4°</option>
                                                                        <option value="5" ${grado=='5' || grado=='5°'
                                                                            ? 'selected' : '' }>5°</option>
                                                                    </select>
                                                                    <c:if test="${errorGrado}">
                                                                        <div class="invalid-feedback">El grado debe ser
                                                                            3°, 4° o 5°</div>
                                                                    </c:if>
                                                                    <small class="form-text text-muted">
                                                                        <i class="fas fa-info-circle me-1"></i>El grado
                                                                ...
                                                                <%-- Campo de contraseña --%>
                                                                    <div class="mb-3">
                                                                        <label class="form-label fw-semibold">Contraseña
                                                                            <span class="text-danger">*</span></label>
                                                                        <div class="position-relative">
                                                                            <input type="password" name="password"
                                                                                id="passwordInput"
                                                                                class="form-control password-field ${errorPassword ? 'is-invalid' : ''}"
                                                                                maxlength="20" required
                                                                                placeholder="Crea su contraseña" />
                                                                            <button
                                                                                class="btn btn-sm btn-outline-secondary position-absolute top-50 end-0 translate-middle-y me-2 toggle-pass"
                                                                                type="button"
                                                                                style="z-index: 10;">Ver</button>
                                                                            <c:if test="${errorPassword}">
                                                                                <div class="invalid-feedback">La
                                                                    ...
                                                                    <%-- Requisitos de contraseña en el centro --%>
                                                                        <div class="mb-3">
                                                                            <div class="border rounded p-3 bg-light">
                                                                                <small
                                                                                    class="fw-bold text-muted d-block mb-2">
                                                                                    <i
                                                                                        class="fas fa-shield-alt me-1"></i>Requisitos
                                                                                    de contraseña:
                                                                                </small>
                                                                                <div class="password-requirement d-flex align-items-center mb-1"
                                                                                    id="req-letters-reg">
                                                                                    <span
                                                                                        class="requirement-icon me-2">❌</span>
                                                                                ...
                                                                                <div class="password-requirement d-flex align-items-center mb-1"
                                                                                    ...
                                                                                    <span
                                                                                        class="requirement-icon me-2">❌</span>
                                                                                    <small>Mínimo 1 carácter especial
                                                                                        (!@#$%^&*)</small>
                                                                                </div>
                                                                                <div class="password-requirement d-flex align-items-center mb-1"
                                                                                    id="req-length-reg">
                                                                        ...
                                                                        <%-- Campo de confirmar contraseña --%>
                                                                            <div class="mb-3">
                                                                                <label
                                                                                    class="form-label fw-semibold">Confirmar
                                                                                    contraseña <span
                                                                                ...
                                                                                <div class="position-relative">
                                                                                    ...
                                                                                    <button
                                                                                        ...
                                                                                        type="button"
                                                                                        style="z-index: 10;">Ver</button>
                                                                                    <div class="invalid-feedback">Repite
                                                                                        la contraseña.</div>
                                                                                </div>
                                                                                <div class="form-text">
                                                                                    <i
                                                                                        class="fas fa-info-circle me-1"></i>Asegúrate
                                                                                    de que ambas contraseñas coincidan
                                                                                </div>
                                                                            </div>
                                                                            ...
                                                                            <div class="d-grid gap-2 mt-4">
                                                                                <button
                                                                                    ...
                                                                                    type="submit">
                                                                                    <i
                                                                                        class="fas fa-user-plus me-2"></i>Registrar
                                                                                    Usuario
                                                                                </button>
                                                                                <a class="btn btn-outline-secondary"
                                                                                    href="${pageContext.request.contextPath}/usuarios">
                                                                                    <i
                                                                                        class="fas fa-arrow-left me-2"></i>Volver
