...
<head>
    ...
    <title>Mis Clases · SumixKids</title>
...
<div class="coming-soon-container">
    <div class="coming-soon-card floating-animation">
        ...
        <p class="coming-soon-description">
            Visualiza y gestiona todas tus clases: horarios, estudiantes inscritos, materiales y seguimiento del progreso.
            <br><br>
            ¡Control total de tus aulas virtuales!
        </p>
