...
<head>
    ...
    <title>Calificaciones · SumixKids</title>
    ...
    <style>
        .coming-soon-container {
            background: linear-gradient(135deg, #dc3545 0%, #fd1537 100%);
            min-height: 100vh;
            display: flex;
            align-items: center;
        ...
        .coming-soon-icon {
            font-size: 8rem;
            background: linear-gradient(45deg, #dc3545, #fd1537);
...
<div class="coming-soon-container">
    <div class="coming-soon-card floating-animation">
        ...
        <p class="coming-soon-description">
            Sistema completo de calificaciones: registra, edita y consulta notas de evaluaciones y exámenes.
            <br><br>
