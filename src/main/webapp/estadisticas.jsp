...
<head>
    ...
    <title>Estadísticas · SumixKids</title>
...
<div class="coming-soon-container">
    <div class="coming-soon-card floating-animation">
        ...
        <p class="coming-soon-description">
            Análisis detallado de rendimiento académico con gráficos y métricas de progreso educativo.
            <br><br>
            ¡Visualiza el éxito con datos precisos!
        </p>
