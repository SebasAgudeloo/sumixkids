                ...
                <div class="card stat-card h-100 border-0 shadow-lg">
                    <div class="card-body text-center p-4">
                        ...
                        <div class="d-grid gap-2">
                            <a href="${pageContext.request.contextPath}/mis_hijos" class="btn btn-info btn-lg fw-bold text-white">
                                <i class="fas fa-users me-2"></i>Ver Hijos
                            </a>
                            <a href="${pageContext.request.contextPath}/vincular_hijo" class="btn btn-outline-info">
