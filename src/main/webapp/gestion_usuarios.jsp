                    ...
                    <div class="collapse navbar-collapse" id="navbarNav">
                        ...
                        <ul class="navbar-nav">
                            <li class="nav-item dropdown">
                                <a class="nav-link dropdown-toggle d-flex align-items-center rounded-pill px-3" href="#"
                                ...
                                <ul class="dropdown-menu dropdown-menu-end shadow-lg border-0">
                                    ...
                                    <li><a class="dropdown-item" href="${pageContext.request.contextPath}/logout"><i
                                                class="fas fa-sign-out-alt me-2 text-danger"></i>Cerrar Sesión</a></li>
                                </ul>
                            </li>
                        </ul>
                    </div>
                            ...
                            <div class="page-header">
                                <div class="d-flex justify-content-between align-items-center">
                                    <div>
                                        ...
                                        <p class="lead text-white mb-0">Administra todos los usuarios del sistema</p>
                                    </div>
                                ...
                                <div class="row g-3">
                                    <div class="col-md-4">
                                        ...
                                        <input type="text" class="form-control" id="buscarUsuario"
                                            placeholder="Nombre, apellido o username..." onkeyup="filtrarUsuarios()">
                                    </div>
                                    <div class="col-md-3">
                                                    ...
                                                    <c:when test="${not empty usuarios}">
                                                        <c:forEach var="usuario" items="${usuarios}" varStatus="status">
                                                            <tr class="usuario-row" data-rol="${usuario.rolId}"
                                                                ...
                                                                <td>
                                                                    <span class="font-monospace">${usuario.email}</span>
                                                                </td>
                                                                <td>
                                                                    <c:choose>
                                                        ...
                                                        <tr>
                                                            <td colspan="8" class="text-center py-5">
                                                                <div class="text-muted">
                                                                    ...
                                                                    <p>No se encontraron usuarios que coincidan con los
                                                                        filtros aplicados.</p>
                                                                </div>
                                                            </td>
                                                        </tr>
