...
<div class="coming-soon-container">
    <div class="coming-soon-card floating-animation">
        ...
        <p class="coming-soon-description">
            Gestiona tu información personal, preferencias y configuración de cuenta. Actualiza datos y personaliza tu experiencia.
            <br><br>
            ¡Tu perfil, totalmente personalizable!
        </p>
