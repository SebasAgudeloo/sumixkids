...
<head>
    ...
    <title>Citas Médicas · SumixKids</title>
...
<div class="coming-soon-container">
    <div class="coming-soon-card floating-animation">
        ...
        <h2 class="coming-soon-subtitle">
            Citas Con El Profesor De Tu Hijo/a
        </h2>
        
        <p class="coming-soon-description">
            Programa y gestiona citas con el profesor de tu hijo/a. Recordatorios automáticos y seguimiento de historial académico.
            <br><br>
            ¡Mantén la educación de tu familia organizada!
        </p>
